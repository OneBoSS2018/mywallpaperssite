...
class WallpapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallpaper" do
    assert_difference('Wallpaper.count') do
      post wallpapers_url, params: { wallpaper: { content: @wallpaper.content, title: @wallpaper.title, user_id: @wallpaper.user_id } }
    end
  ...
  test "should update wallpaper" do
    patch wallpaper_url(@wallpaper), params: { wallpaper: { content: @wallpaper.content, title: @wallpaper.title, user_id: @wallpaper.user_id } }
